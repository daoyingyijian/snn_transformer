...
class TriBaseNode(base.MemoryModule):
    ...
    def neuronal_fire(self):
        ...
        * :ref:`中文API <BaseNode.neuronal_fire-cn>`
        ...
        return self.surrogate_function(self.v - self.v_threshold)-self.surrogate_function(-self.v_threshold - self.v)
...
"""        
data=[[[0.6]] , [[0.5]] , [[1.7]] , [[1.3]] , [[1.2]]]
data=torch.tensor(data)
net_s = TriLIFNode(step_mode='m')
print(data.size())
print(net_s(data))
print(net_s.v)
net_ss = spikingjelly.activation_based.neuron.LIFNode(step_mode='m')
print(net_ss(data))
print(net_ss.v)
net_t = TriLIFNode(step_mode='m')
print(data.size())
print(net_t(-data))
print(net_t.v)
net_tt = spikingjelly.activation_based.neuron.LIFNode(step_mode='m')
print(net_tt(-data))
print(net_tt.v)
"""